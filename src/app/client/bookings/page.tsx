                    ...
                    <div className="flex items-start gap-4">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-1">
                          <h3 className="font-cormorant text-lg font-semibold text-ink truncate">
                            {booking.event_name}
                          </h3>
                        ...
                        <p className="text-xs text-mid-gray mt-1">
                          {new Date(booking.event_date).toLocaleDateString("en-ZA", {
                            ...
                            month: "long",
                            day: "numeric",
                          })} · {booking.event_format} · {booking.duration_minutes}min
                        </p>
                      ...
                      <div className="text-right shrink-0">
                        <p className="font-cormorant text-xl font-bold text-gold">
